...
<div class="help">
  ...
  <p>{ts domain='com.aghstrategies.idbsurvey'}The survey form is at <a href="http://www.thirdspacestudio.com/idbsurvey/" target="_blank">http://www.thirdspacestudio.com/idbsurvey/</a>: the question numbers here correspond to those on the &ldquo;Your Results&rdquo; section.{/ts}</p>
</div>
